...
<li class="nav-item">
<a href="student-details.html" class="nav-link"><i class="fas fa-angle-right"></i>Fee Collection</a>
</li>

<li class="nav-item">
<a href="admit-form.html" class="nav-link"><i class="fas fa-angle-right"></i>Fine Collection</a> 
</li>


<li class="nav-item">
<a href="admit-form.html" class="nav-link"><i class="fas fa-angle-right"></i>Manage Cashier</a> 
</li>



<li class="nav-item">
<a href="admit-form.html" class="nav-link"><i class="fas fa-angle-right"></i>Message</a> 
</li>
